...
final class VideoThumbnailsExtractor {
    ...
    static void extractThumbnails(final @NonNull MediaInput input,
        ...
        try {
            ...
            if (mediaFormat != null) {
                ...
                duration = handleDuration(mediaFormat);
            ...
            handleFinally(outputSurface, decoder, extractor);
        }
    }

    private static long handleDuration(MediaFormat mediaFormat) {
        long duration = 0;
    ...
    private static void handleFinally(OutputSurface outputSurface, MediaCodec decoder, MediaExtractor extractor) {
