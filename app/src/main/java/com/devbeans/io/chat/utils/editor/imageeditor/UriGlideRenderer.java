...
import com.devbeans.io.chat.utils.BitmapUtil;
import com.devbeans.io.chat.utils.RendererContext;
import com.devbeans.io.chat.utils.editor.DecryptableStreamUriLoader;
...
public final class UriGlideRenderer implements SelectableRenderer {
    ...
    Bitmap blur(Bitmap bitmap, Context context, float blurRadius) {
    ...
    private static @NonNull
    Point scaleKeepingAspectRatio(@NonNull Point dimens, int maxDimen) {
        int outX = dimens.x;
        int outY = dimens.y;
