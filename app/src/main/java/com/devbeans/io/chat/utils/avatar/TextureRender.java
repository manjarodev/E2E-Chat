...
import com.devbeans.io.chat.utils.TranscodingException;
...
public final class TextureRender {
    ...
    public TextureRender(boolean flipX) {
    ...
    public void drawFrame(SurfaceTexture st) throws TranscodingException {
     ...
     */
    public void surfaceCreated() throws TranscodingException {
    ...
    public static void checkGlError(String msg) throws TranscodingException {
