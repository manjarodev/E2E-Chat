...
public class TooltipPopup extends PopupWindow {
    ...
    private TooltipPopup(@NonNull View anchor,
        ...
        switch (rawPosition) {
            case POSITION_ABOVE:
                arrow = getContentView().findViewById(R.id.tooltip_arrow_bottom);
                break;
            case POSITION_BELOW:
                arrow = getContentView().findViewById(R.id.tooltip_arrow_top);
                break;
            case POSITION_START:
                arrow = getContentView().findViewById(R.id.tooltip_arrow_end);
                break;
            case POSITION_END:
                arrow = getContentView().findViewById(R.id.tooltip_arrow_start);
                break;
            default:
    ...
    private static void setArrowHorizontalPosition(@NonNull View arrow, @NonNull View anchor) {
        ...
        arrow.setTranslationX((float) anchorCenterX - arrowCenterX);
    }
    ...
    private static void setArrowVerticalPosition(@NonNull View arrow, @NonNull View anchor) {
        ...
        arrow.setTranslationY((float) anchorCenterY - arrowCenterY);
    }
