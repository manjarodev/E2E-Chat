...
import com.devbeans.io.chat.utils.FlashModeConverter;
...
public final class ChatCameraView extends FrameLayout {
    static final String TAG = Log.tag(ChatCameraView.class);
    ...
    ChatCameraXModule mCameraModule;
    ...
    public ChatCameraView(@NonNull Context context) {
        this(context, null);
    }

    public ChatCameraView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChatCameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    @RequiresApi(21)
    public ChatCameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr,
                          int defStyleRes) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        mCameraModule = new ChatCameraXModule(this, error -> {
