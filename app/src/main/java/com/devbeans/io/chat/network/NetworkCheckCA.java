...
public class NetworkCheckCA {
    private static final String TAG = "NetworkCheck";
    public static OkHttpClient.Builder httpClient;
    private static NetworkCheckCA object;
    private final ApiServices services;
    private Retrofit networkClient = null;


    private NetworkCheckCA() {
        Gson gson = new GsonBuilder().create();
        Context context = MainApp.Companion.getAppContext();
        OkHttpClient.Builder httpClient = new OkHttpClient.Builder();
        httpClient.retryOnConnectionFailure(true);
        httpClient.connectTimeout(30, TimeUnit.MILLISECONDS);
        httpClient.readTimeout(40, TimeUnit.MILLISECONDS);
        httpClient.writeTimeout(40, TimeUnit.MILLISECONDS);
...
//        OkHttpClient client = getUnsafeOkHttpClient();
    ...
    public synchronized static NetworkCheckCA getInstance() {
        if (object == null) {
            object = new NetworkCheckCA();
        }
        return object;
    }
    ...
    public static ApiServices apis() {
        return NetworkCheckCA.getInstance().getApiServices();
    }
...
//                Log.e("OKHTTP::"," 2 ="+message);
    ...
    public static OkHttpClient getUnsafeOkHttpClient() {
        try {
            ...
            builder.callTimeout(1500, TimeUnit.MILLISECONDS);
