...
public final class AnimationMatrix {
    ...
    public static AnimationMatrix NULL = new AnimationMatrix();
    ...
    public static @NonNull AnimationMatrix animate(@NonNull Matrix from, @NonNull Matrix to, @Nullable Runnable invalidate) {
        if (invalidate == null) {
            return NULL;
        }
     ...
     */
    public static @NonNull AnimationMatrix singlePulse(@NonNull Matrix pulse, @Nullable Runnable invalidate) {
        if (invalidate == null) {
            return NULL;
        }
     ...
     */
    public void preConcatValueTo(@NonNull Matrix onTo) {
     ...
     * Append the current animation value.
     */
    public void preConcatValueTo(@NonNull CanvasMatrix canvasMatrix) {
        if (!canAnimate) return;
