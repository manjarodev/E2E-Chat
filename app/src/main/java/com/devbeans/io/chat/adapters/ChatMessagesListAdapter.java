...
public abstract class ChatMessagesListAdapter<MESSAGE extends IMessage>
        extends RecyclerView.Adapter<ViewHolder>
        implements RecyclerScrollMoreListener.OnLoadMoreListener {

    public static boolean isSelectionModeEnabled;

    protected List<com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper> items;
    private ChatMessageHolders holders;
    ...
    private com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageClickListener<MESSAGE> onMessageClickListener;
    private com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageViewClickListener<MESSAGE> onMessageViewClickListener;
    private com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageLongClickListener<MESSAGE> onMessageLongClickListener;
    private com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageViewLongClickListener<MESSAGE> onMessageViewLongClickListener;
    private ImageLoader imageLoader;
    private RecyclerView.LayoutManager layoutManager;
    private MessagesListStyle messagesListStyle;
    private DateFormatter.Formatter dateHeadersFormatter;
    private SparseArray<com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageViewClickListener> viewClickListenersArray = new SparseArray<>();
     ...
     */
    public ChatMessagesListAdapter(String senderId, ImageLoader imageLoader) {
        this(senderId, new ChatMessageHolders(), imageLoader);
    }
     ...
     * @param imageLoader image loading method.
     */
    public ChatMessagesListAdapter(String senderId, ChatMessageHolders holders,
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper wrapper = items.get(position);
    ...
    public int getMessagesCount() {
        int count = 0;
        for (com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper item : items) {
    ...
    public void addToStart(MESSAGE message, boolean scroll) {
        Stopwatch stopwatch = new Stopwatch("Adding in view");
        stopwatch.split("starting add in view");
        boolean isNewMessageToday = !isPreviousSameDate(0, message.getCreatedAt());
        stopwatch.split("checking if today");
        if (isNewMessageToday) {
            stopwatch.split("is new message today");
            items.add(0, new com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<>(message.getCreatedAt()));
        }
        com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<MESSAGE> element = new com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<>(message);
        items.add(0, element);
        stopwatch.split("notifying range change");
        notifyItemRangeInserted(0, isNewMessageToday ? 2 : 1);
        if (layoutManager != null && scroll) {
            layoutManager.scrollToPosition(0);
        }
        stopwatch.split("View was added and moved");
        stopwatch.stop(Stopwatch.TAG);
        if (MainApp.Companion.getStopwatchOverAll() != null) {
            MainApp.Companion.getStopwatchOverAll().stop(Stopwatch.TAG);
            MainApp.Companion.setStopwatchOverAll(null);
        }
//        Objects.requireNonNull(MainApp.Companion.getStopwatchOverAll()).split("message added done");
//        MainApp.Companion.getStopwatchOverAll().stop(Stopwatch.TAG);
//        MainApp.Companion.setStopwatchOverAll(null);
    }
    ...
    public boolean update(String oldId, MESSAGE newMessage) {
        ...
        if (position >= 0) {
            com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<MESSAGE> element = new com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<>(newMessage);
     ...
     */
    public void enableSelectionMode(com.stfalcon.chatkit.messages.MessagesListAdapter.SelectionListener selectionListener) {
    ...
    public abstract void enableSelectionMode(SelectionListener selectionListener);

    /**
     * Disables selection mode and removes {@link com.stfalcon.chatkit.messages.MessagesListAdapter.SelectionListener}.
     */
    ...
    public ArrayList<MESSAGE> getSelectedMessages() {
        ...
        for (com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper wrapper : items) {
     ...
     * @return formatted text by {@link com.stfalcon.chatkit.messages.MessagesListAdapter.Formatter}. If it's {@code null} - {@code MESSAGE#toString()} will be used.
     */
    public String getSelectedMessagesText(com.stfalcon.chatkit.messages.MessagesListAdapter.Formatter<MESSAGE> formatter, boolean reverse) {
     ...
     * @return formatted text by {@link com.stfalcon.chatkit.messages.MessagesListAdapter.Formatter}. If it's {@code null} - {@code MESSAGE#toString()} will be used.
     */
    public String copySelectedMessagesText(Context context, com.stfalcon.chatkit.messages.MessagesListAdapter.Formatter<MESSAGE> formatter, boolean reverse) {
        String copiedText = getSelectedText(formatter, reverse);
    ...
    public abstract String getSelectedMessagesText(Formatter formatter, boolean reverse);

    public abstract String copySelectedMessagesText(Context context, Formatter formatter, boolean reverse);

    /**
     * Unselect all of the selected messages. Notifies {@link com.stfalcon.chatkit.messages.MessagesListAdapter.SelectionListener} with zero count.
     */
    public void unselectAllItems() {
        for (int i = 0; i < items.size(); i++) {
            com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper wrapper = items.get(i);
     ...
     */
    public void setOnMessageClickListener(com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageClickListener<MESSAGE> onMessageClickListener) {
     ...
     */
    public void setOnMessageViewClickListener(com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageViewClickListener<MESSAGE> onMessageViewClickListener) {
     ...
     * @param onMessageViewClickListener click listener.
     */
    public void registerViewClickListener(int viewId, com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageViewClickListener<MESSAGE> onMessageViewClickListener) {
     ...
     */
    public void setOnMessageLongClickListener(com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageLongClickListener<MESSAGE> onMessageLongClickListener) {
     ...
     */
    public void setOnMessageViewLongClickListener(com.stfalcon.chatkit.messages.MessagesListAdapter.OnMessageViewLongClickListener<MESSAGE> onMessageViewLongClickListener) {
     ...
     */
    public void setLoadMoreListener(com.stfalcon.chatkit.messages.MessagesListAdapter.OnLoadMoreListener loadMoreListener) {
        this.loadMoreListener = loadMoreListener;
    }

    public abstract void setOnMessageClickListener(OnMessageClickListener onMessageClickListener);

    public abstract void setOnMessageViewClickListener(OnMessageViewClickListener onMessageViewClickListener);

    public abstract void registerViewClickListener(int viewId, OnMessageViewClickListener onMessageViewClickListener);

    public abstract void setOnMessageLongClickListener(OnMessageLongClickListener onMessageLongClickListener);

    public abstract void setOnMessageViewLongClickListener(OnMessageViewLongClickListener onMessageViewLongClickListener);

    public abstract void setLoadMoreListener(OnLoadMoreListener loadMoreListener);
    ...
    protected void generateDateHeaders(List<MESSAGE> messages) {
        for (int i = 0; i < messages.size(); i++) {
            ...
            this.items.add(new com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<>(message));
            if (messages.size() > i + 1) {
                MESSAGE nextMessage = messages.get(i + 1);
                if (!DateFormatter.isSameDay(message.getCreatedAt(), nextMessage.getCreatedAt())) {
                    this.items.add(new com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<>(message.getCreatedAt()));
                }
            } else {
                this.items.add(new com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<>(message.getCreatedAt()));
            }
    ...
    private View.OnClickListener getMessageClickListener(final com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<MESSAGE> wrapper) {
        return view -> {
    ...
    private View.OnLongClickListener getMessageLongClickListener(final com.stfalcon.chatkit.messages.MessagesListAdapter.Wrapper<MESSAGE> wrapper) {
        return view -> {
            if (selectionListener == null) {
    ...
    private String getSelectedText(com.stfalcon.chatkit.messages.MessagesListAdapter.Formatter<MESSAGE> formatter, boolean reverse) {
    ...
    public static abstract class BaseMessageViewHolder<MESSAGE extends IMessage>
         ...
         */
        protected ImageLoader imageBaseLoader;
