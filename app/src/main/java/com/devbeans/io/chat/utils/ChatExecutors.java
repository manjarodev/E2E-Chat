...
public final class ChatExecutors {

    public static final ExecutorService UNBOUNDED  = ThreadUtil.trace(Executors.newCachedThreadPool(new NumberedThreadFactory("chat-unbounded")));
    public static final ExecutorService BOUNDED    = ThreadUtil.trace(Executors.newFixedThreadPool(4, new NumberedThreadFactory("chat-bounded")));
    public static final ExecutorService SERIAL     = ThreadUtil.trace(Executors.newSingleThreadExecutor(new NumberedThreadFactory("chat-serial")));
    public static final ExecutorService RECEIVE     = ThreadUtil.trace(Executors.newSingleThreadExecutor(new NumberedThreadFactory("chat-serial-message-receive")));
    public static final ExecutorService SEND     = ThreadUtil.trace(Executors.newSingleThreadExecutor(new NumberedThreadFactory("chat-serial-message-send")));
    public static final ExecutorService BOUNDED_IO = ThreadUtil.trace(newCachedBoundedExecutor("chat-io-bounded", 1, 32, 30));
    public static final ExecutorService RECEIVE_LIFO = ThreadUtil.trace(newFixedLifoThreadExecutor("chat-serial-message-receive-lifo", 1, 32));
