...
import com.devbeans.io.chat.utils.editor.imageeditor.Bisect;
...
/**
 * Contains a reference to the root {@link com.devbeans.io.chat.utils.views.EditorElement}, maintains undo and redo stacks and has a
...
public final class EditorModel implements Parcelable, RendererContext.Ready {
    ...
    private static void restoreStateWithAnimations(@NonNull EditorElement fromRootElement, @NonNull EditorElement toRootElement, @NonNull Runnable onInvalidate, boolean keepEditorState) {
        ...
        for (EditorElement fromElement : fromMap.values()) {
            ...
            if (toElement != null) {
                ...
                // element is removed
                handleRemovingElement(fromRootElement,fromElement,toMap,onInvalidate);
            }
        }
    ...
    private static void handleRemovingElement(EditorElement fromRootElement, EditorElement fromElement, Map<UUID, EditorElement> toMap, Runnable onInvalidate) {
    ...
    private void handleEditingPurpose() {
