...
import com.devbeans.io.chat.models.Pair;
import com.devbeans.io.chat.utils.FontUtil;
import com.devbeans.io.chat.utils.MediaAnimations;
import com.devbeans.io.chat.utils.ParcelUtil;
import com.devbeans.io.chat.utils.RemoveEmojiTextFilter;
import com.devbeans.io.chat.utils.Renderer;
import com.devbeans.io.chat.utils.SimpleProgressDialog;
import com.devbeans.io.chat.utils.SimpleTask;
import com.devbeans.io.chat.utils.ThrottledDebouncer;
import com.devbeans.io.chat.utils.editor.ColorableRenderer;
import com.devbeans.io.chat.utils.editor.EditorModel;
import com.devbeans.io.chat.utils.editor.MultiLineTextRenderer;
import com.devbeans.io.chat.utils.editor.ResizeAnimation;
import com.devbeans.io.chat.utils.editor.SelectableRenderer;
import com.devbeans.io.chat.utils.editor.imageeditor.AndroidFaceDetector;
import com.devbeans.io.chat.utils.editor.imageeditor.BezierDrawingRenderer;
import com.devbeans.io.chat.utils.editor.imageeditor.FaceBlurRenderer;
import com.devbeans.io.chat.utils.editor.imageeditor.FaceDetector;
import com.devbeans.io.chat.utils.editor.imageeditor.FontTypefaceProvider;
import com.devbeans.io.chat.utils.editor.imageeditor.UriGlideRenderer;
        ...
        SimpleTask.run(getLifecycle(), () -> {
            if (mainImage.getRenderer() != null) {
                ...
                if (bitmap != null) {
                    ...
                    Bitmap render = model.render(MainApp.Companion.getAppContext(), size, new FontTypefaceProvider());
                    try {
...
////            saveTask.executeOnExecutor(ChatExecutors.BOUNDED, attachment);
//        });
    }

    @WorkerThread
    public @NonNull
    String renderToSingleUseBlob() {
        ...
        tempFile = new File(MainApp.Companion.getCachePath(), "my_file.jpg");
        try {
            if (tempFile.exists()) {
    ...
    private final ImageEditorView.DragListener dragListener = new ImageEditorView.DragListener() {
        ...
        public void onDragStarted(@Nullable EditorElement editorElement) {
            ...
            if (editorElement == null) {
                setCurrentSelection(null);
            } else if (editorElement.getRenderer() instanceof BezierDrawingRenderer) {
                setCurrentSelection(null);
            } else {
