...
class DownloaderAnonymousGroup : FetchListener {
    ...
    private fun initialize() {
        val fetchConfiguration: FetchConfiguration =
            FetchConfiguration.Builder(MainApp.appContext!!)
                .setNamespace("AnonymousGroupChat")
    ...
    companion object {
        ...
        var downloader: DownloaderAnonymousGroup? = null

        @get:Synchronized
        val instance: DownloaderAnonymousGroup?
            get() {
                if (downloader == null) {
                    downloader = DownloaderAnonymousGroup()
                }
                return downloader
            }
    }
