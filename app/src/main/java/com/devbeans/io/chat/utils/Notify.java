...
//    private static Snackbar snackbar;
    ...
    public static void Toast(String message) {
        Toast.makeText(MainApp.Companion.getAppContext(), message, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void ToastLong(String message) {
        Toast.makeText(MainApp.Companion.getAppContext(), message, Toast.LENGTH_LONG).show();
    }
