...
import com.devbeans.io.chat.utils.BitmapDecodingException;
import com.devbeans.io.chat.utils.BitmapUtil;
import com.devbeans.io.chat.utils.FastCameraModels;
...
public class CameraXUtil {
    ...
    @RequiresApi(21)
    public static ImageResult toJpeg(@NonNull ImageProxy image, boolean flip) throws Exception {
    ...
    public static int toLensFacing( int cameraDirectionInt) {
