...
public class NetworkCheck {
    ...
    private static NetworkCheck object;
...
//        OkHttpClient client = getUnsafeOkHttpClient();
    ...
    public synchronized static NetworkCheck getInstance() {
        if (object == null) {
            object = new NetworkCheck();
        }
        return object;
    }
    ...
    public static ApiServices apis() {
        return NetworkCheck.getInstance().getApiServices();
    }
