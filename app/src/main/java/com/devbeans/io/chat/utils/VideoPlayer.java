...
public class VideoPlayer extends FrameLayout {
    ...
    public void setVideoSource(@NonNull Uri videoSource, boolean autoplay) {
        if (exoPlayer == null) {
            exoPlayer = MainApp.Companion.getExoPlayerPool1().require();
        ...
        mediaItem = MediaItem.fromUri(Objects.requireNonNull(videoSource));
    ...
    public void cleanup() {
        if (this.exoPlayer != null) {
            ...
            MainApp.Companion.getExoPlayerPool1().pool(exoPlayer);
            this.exoPlayer = null;
        }
    }
