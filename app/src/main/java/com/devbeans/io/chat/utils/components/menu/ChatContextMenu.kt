...
import com.devbeans.io.chat.utils.views.ContextMenuList
 ...
 */
class ChatContextMenu private constructor(
    val anchor: View,
    ...
    private fun show(): ChatContextMenu {
    ...
    class Builder(
        ...
        fun show(items: List<ActionItem>): ChatContextMenu {
