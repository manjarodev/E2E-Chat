...
import com.devbeans.io.chat.models.StaticEmojiPageModel
import com.devbeans.io.chat.utils.EmojiCategory
import com.devbeans.io.chat.utils.ScreenDensity
...
//            }
        ...
        private fun loadAssetBasedEmojis(): EmojiSource {
            val emojiData: InputStream = MainApp.appContext!!.assets.open("emoji/emoji_data.json")
