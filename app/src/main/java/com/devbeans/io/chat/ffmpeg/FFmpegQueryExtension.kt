...
class FFmpegQueryExtension {
     ...
     */
    fun compressImage(inputPath: String, outputPath: String): Array<String> {
        val inputs: ArrayList<String> = ArrayList()
        inputs.apply {
            add("-i")
            add(inputPath)
     ...
     * compress images
     */
    fun compressImage(inputPath: String, outputPath: String, tag: String): Array<String> {
        Log.v("hTAG", "compressImage: anti rotate $tag")
        val inputs: ArrayList<String> = ArrayList()
        inputs.apply {
            add("-i")
            add(inputPath)
