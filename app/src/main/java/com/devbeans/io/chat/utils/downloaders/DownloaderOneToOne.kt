...
class DownloaderOneToOne : FetchListener {
        ...
        CoroutineScope(Dispatchers.IO).launch(coroutineExceptionHandler)
        {
            ...
            launch {
                ...
                try {
                    ...
                    handleDecryptFile(file, download)
                } catch (e: Exception) {
                    Log.e(TAG, e.message)
                    e.printStackTrace()
                }
    ...
    private fun handleDecryptFile(file: File, download: Download) {
    ...
    companion object {
        ...
        var downloader: DownloaderOneToOne? = null

        @get:Synchronized
        val instance: DownloaderOneToOne?
            get() {
                if (downloader == null) {
                    downloader = DownloaderOneToOne()
                }
                return downloader
            }
    }
