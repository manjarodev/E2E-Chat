...
public class NetworkKds {
    private static final String TAG = "Network";
    public static OkHttpClient.Builder httpClient;
    private static NetworkKds object;
    private final APIInterface services;
...
//        OkHttpClient client = getUnsafeOkHttpClient();
        ...
        networkClient = new Retrofit.Builder()
                .baseUrl(Configurations.INSTANCE.getKDSBaseUrl())
                .addConverterFactory(GsonConverterFactory.create(gson))
                .client(getUnsafeOkHttpClient())
                .build();
        services = networkClient.create(APIInterface.class);
        Network.httpClient = httpClient;

    }

    public synchronized static NetworkKds getInstance() {
        if (object == null) {
            object = new NetworkKds();
        }
        return object;
    }
