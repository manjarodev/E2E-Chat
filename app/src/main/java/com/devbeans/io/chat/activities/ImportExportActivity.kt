...
import com.devbeans.io.chat.databinding.ActivityImportExportBinding
 ...
 */
class ImportExportActivity : BaseActivity(), ExpiryCallback {

    private var mBinding: ActivityImportExportBinding? = null


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_import_export)
    ...
    override fun onDestroy() {
        super.onDestroy()
        Utills.clearCacheDir(this@ImportExportActivity)
    }
