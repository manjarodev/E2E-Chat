...
import static com.devbeans.io.chat.utils.ThemeUtil.isDarkTheme;
...
import com.devbeans.io.chat.utils.ThemeUtil;
...
public enum MaterialColor {
    ...
    private static final Map<String, MaterialColor> COLOR_MATCHES = ImmutableMap.<String, MaterialColor>builder()
            .put("red", CRIMSON)
    ...
    public @ColorInt
    int toNotificationColor(@NonNull Context context) {
    ...
    public @ColorInt
    int toConversationColor(@NonNull Context context) {
        return context.getResources().getColor(mainColor);
    }

    public @ColorInt
    int toAvatarColor(@NonNull Context context) {
        return context.getResources().getColor(isDarkTheme(context) ? shadeColor : mainColor);
    }

    public @ColorInt
    int toActionBarColor(@NonNull Context context) {
        return context.getResources().getColor(mainColor);
    }

    public @ColorInt
    int toStatusBarColor(@NonNull Context context) {
        return context.getResources().getColor(mainColor);
    }

    public @ColorRes
    int toQuoteBarColorResource(@NonNull Context context, boolean outgoing) {
        if (!outgoing) {
    ...
    public @ColorInt
    int toQuoteBackgroundColor(@NonNull Context context, boolean outgoing) {
        if (!outgoing) {
    ...
    public @ColorInt
    int toQuoteFooterColor(@NonNull Context context, boolean outgoing) {
        if (!outgoing) {
            int color = toConversationColor(context);
