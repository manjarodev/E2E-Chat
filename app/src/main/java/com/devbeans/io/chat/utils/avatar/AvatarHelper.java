...
import com.devbeans.io.chat.utils.ByteUnit;
...
//    InputStream getAvatar(@NonNull Context context, @NonNull RecipientId recipientId) throws IOException {
...
//    }
     ...
     */
//    public static @NonNull
//    OutputStream getOutputStream(@NonNull Context context, @NonNull RecipientId recipientId, boolean isSyncAvatar) throws IOException {
//        AttachmentSecret attachmentSecret = AttachmentSecretProvider.getInstance(context).getOrCreateAttachmentSecret();
...
//    StreamDetails getSelfProfileAvatarStream(@NonNull Context context) {
...
//    File getAvatarFile(@NonNull Context context, @NonNull RecipientId recipientId) {
...
//    private static @NonNull
//    File getAvatarFile(@NonNull Context context, @NonNull RecipientId recipientId, boolean isSyncAvatar) {
