...
//        extras.putString(EXTRA_THREAD_RECIPIENT_ID, threadRecipient);
//        extras.putString(EXTRA_AVATAR_RECIPIENT_ID, avatarRecipient);
//        extras.putString(EXTRA_INDIVIDUAL_RECIPIENT_ID, sender);
