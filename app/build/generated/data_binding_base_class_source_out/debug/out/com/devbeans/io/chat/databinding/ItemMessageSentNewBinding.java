...
public final class ItemMessageSentNewBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EmojiTextView messageText0;
  ...
  private ItemMessageSentNewBinding(@NonNull RelativeLayout rootView, @NonNull TextView editedText,
      @NonNull TextView editedTextCon, @NonNull ImageView ivForwarded,
      @NonNull LinearLayout layoutForwardedTextSent, @NonNull EmojiTextView messageText0,
  ...
  @NonNull
  public static ItemMessageSentNewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMessageSentNewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_message_sent_new, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMessageSentNewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      EmojiTextView messageText0 = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemMessageSentNewBinding((RelativeLayout) rootView, editedText, editedTextCon,
          ivForwarded, layoutForwardedTextSent, messageText0, messageText0Con, textDisappearSent,
          textOutgoingLayoutBubbleText, textSendingTextMessageLayout, textTextSendTick,
          textTextSendTickCon, textTextviewTime, textTextviewTimeCon, textTimeAndTickLayout,
          textTimeAndTickLayoutCon, tvForwarded);
    }
