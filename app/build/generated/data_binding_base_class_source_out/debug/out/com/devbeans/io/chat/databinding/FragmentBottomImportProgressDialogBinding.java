...
public final class FragmentBottomImportProgressDialogBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentBottomImportProgressDialogBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentBottomImportProgressDialogBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static FragmentBottomImportProgressDialogBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.fragment_bottom_import_progress_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBottomImportProgressDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBottomImportProgressDialogBinding((LinearLayout) rootView, ivImage,
