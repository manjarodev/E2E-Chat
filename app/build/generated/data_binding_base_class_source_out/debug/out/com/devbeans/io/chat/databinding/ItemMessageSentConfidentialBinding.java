...
public final class ItemMessageSentConfidentialBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageView textViewOnceSent;

  @NonNull
  public final TextView tvForwarded;

  private ItemMessageSentConfidentialBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull LinearLayout textTimeAndTickLayoutCon, @NonNull ImageView textViewOnceSent,
    ...
    this.textViewOnceSent = textViewOnceSent;
  ...
  @NonNull
  public static ItemMessageSentConfidentialBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMessageSentConfidentialBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_message_sent_confidential, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMessageSentConfidentialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_view_once_sent;
      ImageView textViewOnceSent = ViewBindings.findChildViewById(rootView, id);
      if (textViewOnceSent == null) {
        break missingId;
      }
      ...
      return new ItemMessageSentConfidentialBinding((RelativeLayout) rootView, editedText,
          ...
          textTimeAndTickLayout, textTimeAndTickLayoutCon, textViewOnceSent, tvForwarded);
    }
