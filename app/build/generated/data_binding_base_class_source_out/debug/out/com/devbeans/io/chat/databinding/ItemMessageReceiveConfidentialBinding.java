...
public final class ItemMessageReceiveConfidentialBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageView textViewOnceReceive;

  private ItemMessageReceiveConfidentialBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull ImageView textViewOnceReceive) {
    ...
    this.textViewOnceReceive = textViewOnceReceive;
  }
  ...
  @NonNull
  public static ItemMessageReceiveConfidentialBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMessageReceiveConfidentialBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_message_receive_confidential, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMessageReceiveConfidentialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_view_once_receive;
      ImageView textViewOnceReceive = ViewBindings.findChildViewById(rootView, id);
      if (textViewOnceReceive == null) {
        break missingId;
      }

      return new ItemMessageReceiveConfidentialBinding((RelativeLayout) rootView, download,
          ...
          textTimeAndTickLayout, textTvGroupMemberName, textViewOnceReceive);
    }
