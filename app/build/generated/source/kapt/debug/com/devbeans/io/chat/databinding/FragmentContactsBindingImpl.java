...
public class FragmentContactsBindingImpl extends FragmentContactsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.add_contact_layout, 4);
        sViewsWithIds.put(R.id.iv_contact, 5);
        sViewsWithIds.put(R.id.tv_new_contact, 6);
        sViewsWithIds.put(R.id.iv_qr, 7);
        sViewsWithIds.put(R.id.rv_contacts, 8);
    }
    // views
    @NonNull
