...
public final class IdentityKeyPairDao_Impl implements IdentityKeyPairDao {
  ...
  private final EntityInsertionAdapter<IdentityKeyPair> __insertionAdapterOfIdentityKeyPair;
  ...
  public IdentityKeyPairDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfIdentityKeyPair = new EntityInsertionAdapter<IdentityKeyPair>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR ABORT INTO `IdentityKeyPair` (`id`,`privateKeyByte`,`identifier`,`pubPrivateKeyByte`) VALUES (nullif(?, 0),?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, IdentityKeyPair value) {
    ...
    this.__preparedStmtOfInsertKey = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "insert into identityKeyPair (privateKeyByte) values (?) ";
        return _query;
      }
    };
    this.__preparedStmtOfInsertidentiferKey = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "insert into identityKeyPair (identifier) values (?) ";
        return _query;
      }
    };
    this.__preparedStmtOfInsertpubKey = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "insert into identityKeyPair (pubPrivateKeyByte) values (?) ";
        return _query;
      }
    };
    this.__preparedStmtOfUpdatePrivateKey = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "update identityKeyPair set privateKeyByte=? where identifier=?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdatePublicKey = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "update identityKeyPair set pubPrivateKeyByte=? where identifier=?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insertKeys(final IdentityKeyPair identityKeyPair) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfIdentityKeyPair.insert(identityKeyPair);
  ...
  @Override
  public IdentityKeyPair getKeys(final byte[] identifier) {
    final String _sql = "select * from identityKeyPair where identifier=?";
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _result = new IdentityKeyPair(_tmpId,_tmpPrivateKeyByte,_tmpIdentifier,_tmpPubPrivateKeyByte);
      } else {
        _result = null;
      }
      return _result;
  ...
  @Override
  public List<IdentityKeyPair> getAllKeys() {
    final String _sql = "SELECT * FROM identityKeyPair";
    ...
    try {
      ...
      final int _cursorIndexOfIdentifier = CursorUtil.getColumnIndexOrThrow(_cursor, "identifier");
      final int _cursorIndexOfPubPrivateKeyByte = CursorUtil.getColumnIndexOrThrow(_cursor, "pubPrivateKeyByte");
      final List<IdentityKeyPair> _result = new ArrayList<IdentityKeyPair>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final IdentityKeyPair _item;
        final int _tmpId;
        _tmpId = _cursor.getInt(_cursorIndexOfId);
        final byte[] _tmpPrivateKeyByte;
        if (_cursor.isNull(_cursorIndexOfPrivateKeyByte)) {
        ...
        _item = new IdentityKeyPair(_tmpId,_tmpPrivateKeyByte,_tmpIdentifier,_tmpPubPrivateKeyByte);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  @Override
  public IdentityKeyPair getKeyID(final int id) {
    final String _sql = "Select * from identityKeyPair where id =?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
